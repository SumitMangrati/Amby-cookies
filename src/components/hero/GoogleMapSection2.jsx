    ...
    >
      {source.length != [] ? 
       ...
       : null}
        ...
        <MarkerF position={{ lat: ambulance.lat, lng: ambulance.lng }}
         >
            <OverlayViewF 
            ...
            >
                <div className="p-2 bg-white font-bold inline-block">
                    <p className="text-black text-[16px]">{ambulance.label}</p>
                </div>
            </OverlayViewF>
         </MarkerF>
...
export default GoogleMapSection2;
